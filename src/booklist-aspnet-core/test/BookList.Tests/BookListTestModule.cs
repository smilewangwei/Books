...
using BookList.Tests.DependencyInjection;
...
namespace BookList.Tests
{
    ...
    public class BookListTestModule : AbpModule
    {
        public BookListTestModule(BookListEntityFrameworkModule abpProjectNameEntityFrameworkModule)
        {
