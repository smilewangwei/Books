...
export class BookServiceProxy {
     ...
     * @return Success
     */
    getPagedBook(filterText: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfBookDto> {
        let url_ = this.baseUrl + "/api/services/app/Book/GetPagedBook?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfBookDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfBookDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetPagedBook(response: HttpResponseBase): Observable<PagedResultDtoOfBookDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfBookDto.fromJS(resultData200) : new PagedResultDtoOfBookDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfBookDto>(<any>null);
    }
    ...
    batchDeleteBook(input: number[] | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Book/BatchDeleteBook";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getForEditBook(id: number | null | undefined): Observable<GetBookForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Book/GetForEditBook?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetForEditBook(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetForEditBook(<any>response_);
                } catch (e) {
    ...
    protected processGetForEditBook(response: HttpResponseBase): Observable<GetBookForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PagedResultDtoOfBookDto implements IPagedResultDtoOfBookDto {
    totalCount: number | undefined;
    items: BookDto[] | undefined;

    constructor(data?: IPagedResultDtoOfBookDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedResultDtoOfBookDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfBookDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfBookDto {
    totalCount: number | undefined;
    items: BookDto[] | undefined;
}
